    ...
    return (
        <nav>
            <ul>
                ...
                <li><a href="/" className={styles.deliveryNav}><span>{navigationTitles.freeDeliveryTitle}</span> <img className={styles.imgFluid} src={freeDeliveryImage} alt="free delivery" /></a></li>
            </ul>
        </nav>
    )
}
